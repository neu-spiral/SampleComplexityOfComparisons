...
if __name__ == "__main__":
    ...
    # file_name = "../data/result/" + error_method + "/" + algorithm + "/" + name_base + ".mat"
    if  True:#not os.path.isfile(file_name):
        ...
        if not os.path.exists("/scratch/tian.pe/colt/data/result/"+error_method+"/"+algorithm+"/"):
            os.makedirs("/scratch/tian.pe/colt/data/result/"+error_method+"/"+algorithm+"/")
        #savemat("../result/Synthetic_CV_noiseless/" + error_method + "/" + algorithm + "/" + name_base + ".mat", out_dict)
        pickle.dump(out_dict, open("/scratch/tian.pe/colt/data/result/"+error_method+"/"+algorithm+"/" + name_base + ".p", 'wb'))
    print "done"
